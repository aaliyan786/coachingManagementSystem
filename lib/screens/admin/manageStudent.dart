...
import 'package:coaching_management_system/screens/signup_page.dart';
...
//   final String? msg;
//   const Call({this.msg}) : super(key: key);
//
//   @override
                    ...
                    child: Column(
                        children: [
                          ...
                          FloatingActionButton(onPressed: (){Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const SignUpPage()));},child: Icon(Icons.add))
                          // Expanded(
                          //  // flex: 1,
